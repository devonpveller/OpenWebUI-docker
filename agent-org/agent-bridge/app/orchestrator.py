...
class Orchestrator:
    ...
    async def _qa_evaluation(
        ...
        instr = (
            ...
            f"a feature that does NOT work end-to-end)? Then reply in EXACTLY this format:\n"
            ...
            f"this ships — the feature not working end-to-end (e.g. stored but never surfaced), "
            f"crashes on its own/edge inputs, missing or inadequate USAGE DOCUMENTATION / help, "
            f"unclear error messages. Write `none` if there are none.\n"
