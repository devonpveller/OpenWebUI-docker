...
| What the gateway *application* is: HTTP endpoints, auth model, provider interface, privacy invariants, Python dev + tests | [`gateway/README.md`](gateway/README.md) |
...
`gateway/` owns the **code**; this file owns the **plane**. Endpoint
