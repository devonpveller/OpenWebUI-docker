...
This note's revision history, and the what and why of each correction, live in
the commit messages;
`git log --follow -- documentation/notes/daily-podcast-reliability-findings.md`
enumerates the revisions.
