...
| commit validated | **`f387e5e506119d690e6da4a30767c3a6d207b885`** — the commit that changes CODE. Everything after it on this branch is this note and PowerShell/YAML **comment text only**, which is checkable rather than asserted: `git diff --name-only f387e5e..HEAD` lists exactly `.github/workflows/ci.yml` and `documentation/notes/u8h4-findings.md`, and `git rev-parse HEAD:scripts/checks/dfu-done.ps1` is `09a8f1e3934978a75444ae2df616a688a8f12d59` at every one of them. The runs below were re-taken from the clone at `2339436`, the last commit that touched `.github`. |
| `.github` tree hash | `9f09a9f10921d5ec7f89c7da2b14f88ddde2414e` at `f387e5e`; `49f318a708ef8940ab487675fd4a126bd0559892` from `2339436` onward (the delta is comment text — PyYAML parses 14 jobs at both) |
