...
def slugify(text):
    ...
    # NFKD splits accented characters into base + combining mark, so dropping the
    # marks folds them to plain ASCII; anything still non-ASCII is not a slug character.
